...
class hdf5_writer:
    ...
    def add_result_df(self,qtl_results_df):
        ...
        column_names = ['snp_id','p_value','beta','beta_se','empirical_feature_p_value', 'indirect_molA_p_value', 'indirect_molA_effect_size', 'indirect_molB_p_value', 'indirect_molB_effect_size']
        try:
...
class text_writer:
    ...
    def __init__(self,output_filename):
        self.column_names = ['feature_id','snp_id','p_value','beta','beta_se','empirical_feature_p_value', 'indirect_molA_p_value', 'indirect_molA_effect_size', 'indirect_molB_p_value', 'indirect_molB_effect_size']
...
class QTL_result_hdf5(tables.IsDescription):
    ...
    indirect_molA_p_value = tables.Float64Col()
    indirect_molA_effect_size = tables.Float64Col()
    indirect_molB_p_value = tables.Float64Col()
    indirect_molB_effect_size = tables.Float64Col()
